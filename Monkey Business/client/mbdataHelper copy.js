...
export async function searchStockAPI (stockName, start, end) { // Search for stock by name
  try {
    const response = await fetch('http://159.203.78.101:3000/api/search', {
      method: 'POST',
      headers: {
...
export async function retrieveInvestorStocks (start, end) { // Failed Authentication should result in a redirect to a landing page or login page
  try {
    const response = await fetch('http://159.203.78.101:3000/api/stocks?' + new URLSearchParams({ start, end }))
    if (response.status >= 400) {
      throw new Error(`Request failed with response code ${response.status}`)
    }
    return await response.json()
...
export async function retrieveStockDetails (stockName, timeFrame) { // Examples of stockSymbol: 'GME', 'AMC', 'TSLA', 'AAPL', 'GOOG', 'MSFT', 'AMZN'
  try {
    const response = await fetch('http://159.203.78.101:3000/api/stockDetails?' + new URLSearchParams({ stockName, timeFrame }))
    if (response.status >= 400) {
      throw new Error(`Request failed with response code ${response.status}`)
    }
    return await response.json()
...
export async function postBuySellStock (stockName, stockPrice, changeType, changeAmount) { // add stock to profile
  try {
    const response = await fetch('http://159.203.78.101:3000/api/stockChange', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
...
export async function getGenStocks (stockQuant) {
  try {
    const response = await fetch('http://159.203.78.101:3000/api/generalStocks?' + new URLSearchParams({ stockQuant }))
    if (response.status >= 400) {
      throw new Error(`Request failed with response code ${response.status}`)
    }
    return await response.json()
...
export async function login (username, password) {
  try {
    const response = await fetch('http://159.203.78.101:3000/api/login', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
...
export async function signUp (username, password, passwordConfirm, email) {
  try {
    const response = await fetch('http://159.203.78.101:3000/api/signup', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
...
export async function logout () {
  try {
    const response = await fetch('http://159.203.78.101:3000/api/logout')
    if (response.status >= 400) {
      throw new Error(`Request failed with response code ${response.status}`)
    }
    return true
...
export async function deleteAccount (username) { // Input of password instead ---TO DO---
  try {
    const response = await fetch(`http://159.203.78.101:3000/api/account/${username}`, {
      method: 'DELETE'
    })
    if (response.status >= 400) {
      throw new Error(`Request failed with response code ${response.status}`)
...
export async function resetPassword (accessKey, username, password, confirmPassword) {
  try {
    const response = await fetch('http://159.203.78.101:3000/api/resetPassword', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
...
export async function forgotPassword (username, email) {
  try {
    const response = await fetch('http://159.203.78.101:3000/api/forgotPassword', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
...
export async function updatePreferences (preferencesObj) {
  try {
    const response = await fetch('http://159.203.78.101:3000/api/preferences', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
...
export async function getUser () {
  try {
    const response = await fetch('http://159.203.78.101:3000/api/user')
    if (response.status >= 400) {
      throw new Error(`Request failed with response code ${response.status}`)
    }
    return await response.json()
...
export async function getMonkeyInvestments () {
  try {
    const response = await fetch('http://159.203.78.101:3000/api/monkey')
    if (response.status >= 400) {
      throw new Error(`Request failed with response code ${response.status}`)
    }
    return await response.json()
